...
function edit_form (data) {
    return (
        <Def>
          <main>
            <h1>Edit Place</h1>
            <form className="form" method="POST" action={`/places/${data.place.id}?_method=PUT`}>
            ...
            <div className="form-group col-sm-6">
                ...
                <input className="form-control" type="number" id="founded" name="founded" value={data.place.founded}/>
            </div>
            </div>
            <input className="btn btn-primary" type="submit" value="Upadte Place" />
            </form>
          </main>
        </Def>
    )
